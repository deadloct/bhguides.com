...
function Disclaimer() {
  ...
  return (
    ...
    >
      For guidance only — bhguides is not responsible for the accuracy of the
      numbers produced by this calculator.
    </Alert>
  )
}
  ...
  return (
    <>
      <p className={styles.overview}>
        This calculator was ported from{' '}
        <a href="https://jsfiddle.net/dchzwg90/">
          Archangel/Cherubim&apos;s awesome jsfiddle
        </a>
        .
      </p>
      <p className={styles.suboverview}>
        Credits to pixelbxss for finding some critical issues with the site and
        for making suggestions, iWushock for sharing the jsfiddle, Uber-gecko
        for asking for it, skye666 for making an awesome spreadsheet calculator
        that I used for ages, and everybody in [DÀRK] for being super rad.
      </p>
      <p className={styles.signature}>--BillyIdol</p>
    </>
  )
}
