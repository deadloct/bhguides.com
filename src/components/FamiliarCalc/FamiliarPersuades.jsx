  ...
  function displayResults() {
    ...
    return (
      <div>
        <h2>Results</h2>
        <p>
          Out of <strong>{results.gameCount.toLocaleString()}</strong> persuade
          attempts:
        </p>
        <ul>
          <li>
            Effective persuade rate: <strong>{results.actualWinRate}%</strong>
          </li>
          <li>
            Successful persuades:{' '}
          ...
          <li>
            Longest winning streak: <strong>{results.bestWinStreak}</strong>{' '}
            persuades in a row
          </li>
          <li>
            Longest losing streak: <strong>{results.worstLossStreak}</strong>{' '}
            fails in a row
          </li>
        </ul>
