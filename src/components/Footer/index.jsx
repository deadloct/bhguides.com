...
export default function Footer() {
    ...
    const fetchLatestCommit = async () => {
      try {
        const response = await fetch(
          'https://api.github.com/repos/deadloct/bhguides.com/commits?per_page=1'
        )
  ...
  return (
    <footer className={styles['site-footer']}>
      ...
      <p className={styles['non-affiliation']}>
        This site is <strong>not</strong> affiliated with Monumental,
        Kongregate, or Juppiomenz.
      </p>
    </footer>
  )
}
