...
export default function Guides() {
    ...
    return (
        <Container key="guides" className={styles["wrapper"]} maxWidth="md">
            ...
            <footer>
                <h2>Credits</h2>
                <p><strong>Guide Authors:</strong> 3riko, 5Rupees, a_poor_ninja, Adhesive81, Alysias, Antomanz, Ballbreaker, BillyIdol, Bisamratte, Bitverse_Andy, Blanquiito, Captain_Crunchie, ChubbyDaemon, Chuck, Colb, Commander, Crow, CyberMuffin, DarkHand6, Dispel1, Dracaris, Dude_WTF, Ee, Eliealsamaan85, Ember, FergusFerret, fohpo, Fyra, Gagf, Gavx, Goku, Goolmuddy, Gylgymesh, Hæl (aka Hael on this page), Huen11, Infermis, ItsMBSCastillo, JDizzle, Jermoshua, JoeBu, John_Hatten2, josiah_4, kruste, Lqd, Maddbz, MaxBrand99, McSploosh, Melody (Choco), Mentle88, MrRager, Mochi, Neflarian, n1ghtmaree, Olivernoko, Orcaaa, PAINisGOD93, PocketApple8104, PrimeDyze, RoastyChicken, ShawnBond, Sizz, Smolder, Special_Delivery, Tarnym, Techno, Toad, Tolton, TooT, TrippyAfro, UnseenAxes, Vanterio, VesaN, Winter, WRLD_EATR, Youreprettycute, ZENICKS, and ZombieSlayer13</p>
