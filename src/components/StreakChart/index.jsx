...
function Panel({
  ...
  const axisLabel =
    unitPlural.charAt(0).toUpperCase() + unitPlural.slice(1) + ' in streak'
    ...
    <div style={{ marginBottom: 4 }}>
      <div style={{ color: labelColor, fontWeight: 600 }}>
        ...
        <span style={{ fontWeight: 400, opacity: 0.75 }}>
          — longest: {max.toLocaleString()}{' '}
          {max === 1 ? unitSingular : unitPlural}
        </span>
      </div>
      <div style={{ color: labelColor, fontSize: 12, opacity: 0.7 }}>
        {subtitle}
      </div>
    </div>
  )
